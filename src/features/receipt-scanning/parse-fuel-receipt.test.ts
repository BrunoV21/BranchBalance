...
describe('Fuel receipt parser', () => {
  it('keeps paid, gross, discount, litres, and pump price distinct', () => {
    const parsed = buildFuelReceiptExpensePrefill(result([
      block('PINGO DOCE', 50), block('10/08/2026', 180), block('DIESEL', 500),
    ...
    expect(parsed).toMatchObject({ profile: 'fuel_v1', description: 'PINGO DOCE', expenseDate: '2026-08-10', amount: '36.01', gross: '40.01', discount: '4.00', litres: '24.5', unitPrice: '1.633', fuelType: 'diesel' });
